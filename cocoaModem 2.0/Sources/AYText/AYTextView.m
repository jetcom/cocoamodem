...
- (TextAttribute*)newAttribute
{
	...
	a->dictionary = [ [ NSDictionary dictionaryWithObjectsAndKeys:a->textColor, NSForegroundColorAttributeName, a->font, NSFontAttributeName, nil ] retain ] ;
	return a ;
}
...
- (void)setTextFont:(NSFont*)newFont attribute:(TextAttribute*)a
{
	...
	if ( newFont ) {
		...
		//  create new dictionary with new font
		oldDictionary = a->dictionary ;
		a->dictionary = [ NSDictionary dictionaryWithObjectsAndKeys:a->textColor, NSForegroundColorAttributeName, a->font, NSFontAttributeName, nil ] ;
		[ a->dictionary retain ] ;
		[ oldDictionary release ] ;
		[ viewLock unlock ] ;
	}
