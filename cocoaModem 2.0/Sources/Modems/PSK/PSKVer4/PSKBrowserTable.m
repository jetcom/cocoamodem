...
- (id)initWithTable:(NSTableView*)which client:(PSKBrowserHub*)client
{
	...
	if ( self ) {
		...
		alarmText = [ [ NSDictionary dictionaryWithObjectsAndKeys:[ NSColor redColor ], NSForegroundColorAttributeName, /*a->font, NSFontAttributeName,*/ nil ] retain ] ;
		...
		freqColumn = [ columns objectAtIndex:1 ] ;
		textColumn = [ columns objectAtIndex:0 ] ;
