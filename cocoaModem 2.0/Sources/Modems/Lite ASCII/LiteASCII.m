...
- (id)initIntoTabView:(NSTabView*)tabview manager:(ModemManager*)mgr nib:(NSString*)nib
{
	...
	if ( self ) {
		...
		a.isAlive = YES ;
		a.control = [ [ LiteASCIIControl alloc ] initIntoView:receiverA client:self index:0 ] ;
...
- (id)initIntoTabView:(NSTabView*)tabview manager:(ModemManager*)mgr
{
	...
	return [ self initIntoTabView:tabview manager:mgr nib:@"LiteASCII" ] ;
}
...
{
	if ( [ [ manager nameOfSelectedTabView ] isEqualToString:@"ASCII" ] == NO ) return ;
